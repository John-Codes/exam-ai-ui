...
/// Client-side voice mode (TTS reads AI replies aloud, STT transcribes the
/// learner's answer into the text field and auto-sends). Requires no server.
...
class _VoiceModeButtonV2State extends State<VoiceModeButtonV2>
  ...
  void _maybeRestartListening() {
    if (!mounted || !_voiceMode || widget.isLoading || _speaking || _listening) {
      return;
    }
    _startListening();
  }
